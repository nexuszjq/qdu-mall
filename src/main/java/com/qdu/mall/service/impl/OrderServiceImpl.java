...
import com.qdu.mall.common.*;
import com.qdu.mall.controller.vo.*;
import com.qdu.mall.dao.GoodsMapper;
import com.qdu.mall.dao.OrderItemMapper;
import com.qdu.mall.dao.OrderMapper;
import com.qdu.mall.dao.ShoppingCartItemMapper;
import com.qdu.mall.entity.Goods;
import com.qdu.mall.entity.Order;
import com.qdu.mall.entity.OrderItem;
import com.qdu.mall.entity.StockNum;
import com.qdu.mall.service.OrderService;
import com.qdu.mall.util.BeanUtil;
import com.qdu.mall.util.NumberUtil;
    ...
    public String saveOrder(UserVO user, List<ShoppingCartItemVO> myShoppingCartItems) {
        ...
        if (!CollectionUtils.isEmpty(itemIdList) && !CollectionUtils.isEmpty(goodsIds) && !CollectionUtils.isEmpty(goods)) {
            if (shoppingCartItemMapper.deleteBatch(itemIdList) > 0) {
                List<StockNum> stockNums = BeanUtil.copyList(myShoppingCartItems, StockNum.class);
                int updateStockNumResult = goodsMapper.updateStockNum(stockNums);
