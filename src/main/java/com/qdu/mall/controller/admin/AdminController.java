...
import com.qdu.mall.entity.AdminUser;
import com.qdu.mall.service.AdminUserService;
...
/**
 * @ClassName: com.qdu.mall.controller.admin.AdminController.java
 * @Description:
 * @author: ZhangJunqing
...
public class AdminController {
    ...
    public String login(@RequestParam("userName") String userName,
        ...
        if (adminUser != null) {
            ...
            session.setAttribute("errorMsg", "登陆失败，请联系开发者");
            return "admin/login";
        }
    }
