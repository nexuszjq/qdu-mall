...
/**
 * @ClassName: com.qdu.mall.common.Constants.java
 * @Description: 常量配置
 * @author: ZhangJunqing
...
//    public final static String FILE_UPLOAD_DIC = "/www/server/upload/";
    ...
    //购物车中商品的最大数量
    public final static int SHOPPING_CART_ITEM_TOTAL_NUMBER = 10;
    ...
    //搜索分页的默认条数,每页10条
    public final static int GOODS_SEARCH_PAGE_LIMIT = 15;
